...
window.addEventListener('DOMContentLoaded', function () {
    ...
    // Script hide cookie div at page bottom
    if (document.getElementById('cookie-accept') !== null) {
        document.getElementById('cookie-accept').addEventListener('click', function (event) {
            event.preventDefault();
            document.getElementById('cookie-div').classList.add('d-none');
        })
    }
})
